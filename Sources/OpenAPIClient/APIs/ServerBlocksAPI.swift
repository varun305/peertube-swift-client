...
open class ServerBlocksAPI {
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func apiV1ServerBlocklistServersGet(start: Int? = nil, count: Int? = nil, sort: String? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) {
        return try await apiV1ServerBlocklistServersGetWithRequestBuilder(start: start, count: count, sort: sort, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func apiV1ServerBlocklistServersGetWithRequestBuilder(start: Int? = nil, count: Int? = nil, sort: String? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<Void> {
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func apiV1ServerBlocklistServersHostDelete(host: String, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) {
        return try await apiV1ServerBlocklistServersHostDeleteWithRequestBuilder(host: host, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func apiV1ServerBlocklistServersHostDeleteWithRequestBuilder(host: String, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<Void> {
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func apiV1ServerBlocklistServersPost(apiV1ServerBlocklistServersPostRequest: ApiV1ServerBlocklistServersPostRequest? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) {
        return try await apiV1ServerBlocklistServersPostWithRequestBuilder(apiV1ServerBlocklistServersPostRequest: apiV1ServerBlocklistServersPostRequest, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func apiV1ServerBlocklistServersPostWithRequestBuilder(apiV1ServerBlocklistServersPostRequest: ApiV1ServerBlocklistServersPostRequest? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<Void> {
        let localVariablePath = "/api/v1/server/blocklist/servers"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: apiV1ServerBlocklistServersPostRequest, codableHelper: apiConfiguration.codableHelper)
